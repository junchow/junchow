    ...
    public function index()
    {
        return Admin::content(function (Content $content) {
            ...
            $content->row(function ($row) {
                $row->column(3, new InfoBox('新增用户', 'users', 'aqua', '/admin/users', '1024'));
                $row->column(3, new InfoBox('新增订单', 'shopping-cart', 'green', '/admin/orders', '150%'));
                $row->column(3, new InfoBox('软文数量', 'book', 'yellow', '/admin/articles', '2786'));
                $row->column(3, new InfoBox('文档数量', 'file', 'red', '/admin/files', '698726'));
            });
